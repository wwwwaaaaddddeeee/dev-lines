...
const DEFAULT_DEPTH_COLORS = [
  "53 122 246", // #357af6 blue
  "255 59 59", // #ff3b3b red
  "43 212 107", // #2bd46b green
  "157 92 255", // #9d5cff violet
  "255 122 26", // #ff7a1a orange
  "0 224 192", // #00e0c0 teal
];

const DEFAULTS = {
  lineColor: "237 116 241", // #ed74f1
